...
export const LibraryPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 md:py-24 animate-in fade-in slide-in-from-bottom-6 duration-1000">
      ...
      {/* Card Factory Section - Standardized to rounded-xl */}
      <div className="mb-24 relative">
        <div className="bg-zinc-200 dark:bg-zinc-800 rounded-xl p-1 shadow-2xl">
          <div className="bg-white dark:bg-zinc-900 rounded-lg p-8 md:p-14 border border-zinc-100 dark:border-zinc-800 relative overflow-hidden">
             ...
             <div className="absolute top-0 right-0 w-64 h-64 bg-zinc-50 dark:bg-zinc-800 -rotate-45 translate-x-32 -translate-y-32 flex items-end justify-center pb-8 border border-zinc-100 dark:border-zinc-700">
                <Sparkles size={24} className="text-zinc-200 dark:text-zinc-600" />
             </div>
