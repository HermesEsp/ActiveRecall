...
const NavItem = ({ to, icon: Icon, label }: { to: string; icon: any; label: string }) => (
  <NavLink
    to={to}
    className={({ isActive }) =>
      `relative flex items-center gap-3 px-5 py-2 rounded-lg transition-all duration-500 group ${isActive
...
const MobileNavItem = ({ to, icon: Icon, label }: { to: string; icon: any; label: string }) => (
  <NavLink
    to={to}
    className={({ isActive }) =>
      `flex flex-col items-center gap-1.5 px-6 py-2 transition-all relative ${isActive
        ...
        <div className="flex items-center gap-10">
          <div className="flex items-center gap-3 group cursor-default">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-black tracking-tightest leading-none">ActiveRecall</span>
